...
<div id="wrap">
	<div class="d-flex justify-content-center">
		<div class="mt-5"><h2>비밀번호 찾기</h2></div>
	</div>	
	...
	<div id="searchPwBox">
		<form id="searchPwForm" method="post" action="/user/search-pw">
			<div class="d-flex justify-content-center align-items-center mb-3">
				<span class="font-weight-bold mr-4">이름</span> 
				<input type="text" id="name" name="name" class="form-control col-4 mt-1" placeholder="이름을 입력해주세요">
			</div>
			...
			<button type="submit" id="searchPwBtn2" class="btn btn-secondary">비밀번호 찾기</button>	
		</form>
	</div>	
</div>